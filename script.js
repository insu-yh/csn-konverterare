...
function downloadXml(){
  ...
  // VIKTIGT: Exempelfilerna från det gamla CSN-flödet deklarerar utf-16,
  // men själva bytesen är vanlig text/ASCII. CSN:s uppladdning verkar förvänta sig
  // just den varianten och kan neka äkta UTF-16LE med BOM. Därför laddar vi ner
  // XML som vanlig text, men behåller deklarationen för att matcha befintliga filer.
